        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img class="mw-100" src="/images/VF_ALUMINIOS_LONA.jpg" alt="logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto">
                        @auth
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('jobs.index') }}">Folha de Obra</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('employees.index') }}">Funcionários</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('invoices.index') }}">Faturas</a>
                            </li>
                            <li class="nav-item">
